...
'''
def calculate_telescope_size(_target_obj_physical_size, _target_obj_physical_dist, _number_of_pixels = 100, _wavelength = [522.0, 'nm'], _telescope_size_unit = 'mm'):
    ...
    try:
        ...
        angular_size_in_arcsec_for_pixel = angular_size_in_arcsec/_number_of_pixels
        angular_size_in_rad_for_pixel = angle_units_converter(angular_size_in_arcsec_for_pixel, 'arcsec', 'rad')[0]
        ...
        D = 1.22*(wavelength_m[0]/angular_size_in_rad_for_pixel)
...
telescope_size, object_size = calculate_telescope_size(obj_size, obj_dist, number_of_pixels, wavelength, telescope_size_unit)
